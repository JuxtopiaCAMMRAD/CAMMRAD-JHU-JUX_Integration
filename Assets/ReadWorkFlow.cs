...
public class ReadWorkFlow: MonoBehaviour {
    ...
    private List<CAMMRADMainController.DisplayAnchoredText> displayText;
	private List<CAMMRADMainController.DisplayAnchoredImage> displayImage;

	private List<CAMMRADMainController.FeatureAnchoredObject> featObjects;
    ...
    public void DisplayStep( CAMMRADMainController.CAMMRADStep step ) {
...
//        stepName.text = step.Name;
		...
		foreach( CAMMRADMainController.DisplayAnchoredText entry in displayText ) {
		...
		foreach( CAMMRADMainController.DisplayAnchoredImage myImg in displayImage ) {
            if( myImg.Image_Path == "" ) {
                continue;
            }
		...
		foreach( CAMMRADMainController.FeatureAnchoredObject feat in featObjects ) {
